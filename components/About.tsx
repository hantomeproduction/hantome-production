...
export const About: React.FC = () => {
  ...
  return (
    <section id="about" className="relative w-full min-h-[100dvh] h-auto snap-start snap-always shrink-0 flex flex-col border-b border-white/5 bg-[#080808] overflow-hidden">
        ...
        <div className="flex flex-col pt-8">
            <div className="grid grid-cols-1 lg:grid-cols-12 border-b border-white/5 h-auto lg:h-[28vh]">
                <div className="lg:col-span-5 p-5 md:p-6 lg:p-8 border-b lg:border-b-0 lg:border-r border-white/5 flex flex-col justify-center relative overflow-hidden group">
                    ...
                    <Reveal>
                        <h2 className="text-[8vw] md:text-[5vw] lg:text-[4.5vw] leading-[0.85] font-bold tracking-tighter text-white uppercase mb-3 relative z-10">
                    ...
                    <Reveal delay={100}>
                        <div className="flex items-center gap-3">
                             ...
                             <h3 className="text-base md:text-xl font-bold tracking-tighter text-white uppercase">
                    ...
                    <div className="space-y-4 md:space-y-5 font-light text-gray-400 leading-relaxed text-xs md:text-sm max-w-2xl relative z-10">
                        <Reveal delay={200}>
                            <div className="group/item pl-4 border-l border-white/10 hover:border-green-500 transition-colors duration-500">
                                ...
                                <p className="text-gray-300 group-hover/item:text-white transition-colors duration-500 whitespace-pre-line">
                        ...
                        <Reveal delay={300}>
                             <div className="group/item pl-4 border-l border-white/10 hover:border-green-500 transition-colors duration-500">
                                <strong className="text-green-500 block mb-1.5 text-[10px] md:text-[11px] font-mono uppercase tracking-[0.2em]">[ Vision ]</strong>
            ...
            <div className="w-full">
                <div className="px-6 py-2 border-b border-white/5 bg-[#050505] flex justify-between items-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 divide-y md:divide-y-0 md:divide-x divide-white/5">
                    {members.map((member, index) => (
                        <Reveal key={index} delay={index * 100} width="100%" className="group relative bg-[#080808] hover:bg-[#0c0c0c] transition-colors duration-500">
                            <div className="flex flex-row md:flex-col items-center md:items-stretch p-3 md:p-0">
                                
                                <div className="order-2 md:order-1 shrink-0 w-16 h-16 md:w-full md:h-[40vh] overflow-hidden relative rounded-full md:rounded-none ml-4 md:ml-0 border border-white/10 md:border-0">
                                ...
                                <div className="order-1 md:order-2 flex flex-col justify-start p-4 md:p-6 md:border-t md:border-white/5 group-hover:bg-[#111] transition-colors duration-500">
                                    <div className="mb-2">
                                    ...
                                    <p className="text-[10px] md:text-[11px] font-mono text-green-500 md:text-gray-500 uppercase tracking-widest mb-3">{member.role}</p>
                                    <p className="text-[11px] md:text-[13px] text-gray-300 font-light leading-relaxed whitespace-pre-line group-hover:text-white transition-colors">
                                        {member.desc}
                                    </p>
                                </div>
